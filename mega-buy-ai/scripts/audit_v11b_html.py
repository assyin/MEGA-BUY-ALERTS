...
def main():
    ...
    from _risk_metrics import (compute_risk_metrics, render_html as render_risk_html,
                                render_paper_html, render_paper_pnl_html)
    ...
    H.extend(render_paper_pnl_html(rows))
