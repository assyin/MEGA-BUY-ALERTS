  ...
  return (
    <div className="p-6 space-y-6 max-w-[1600px] mx-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-9 gap-3">
        ...
        <StatCard label="Positions" value={`${positions.length}/${version === 'v3' || version === 'v5' ? 25 : version === 'v4' ? 15 : (version === 'v6' || version === 'v7' || version === 'v8' || version === 'v9' || version.startsWith('v11')) ? 12 : 10}`} sub={`$${inPositions.toFixed(0)} alloc`} icon={<BarChart3 className="w-4 h-4" />} color="text-purple-400" />
