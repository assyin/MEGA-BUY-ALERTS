...
**Tous les 199 trades** ont des features confirmant `range_30m ≤ 1.89` ET `range_4h ≤ 2.58` au moment de l'alerte. Filtre 100% respecté.
...
- Scanner score : **9/10**
- Décision OpenClaw : **BUY STRONG** (75% confiance)
- Bougie 4H : direction **red**, body 1.98%
- RSI : 67.4
